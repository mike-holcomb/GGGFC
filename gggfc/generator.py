...
class GeneratorHistory:
    ...
    def add(self, lh, production_name):
...
class Generator:
    def __init__(self, grammar, p_grow=0.7, max_depth=10):
    ...
    def get_production(self, op_type, depth=1):
        ...
        self.history.add(op_type, production.prefix)
...
if __name__ == "__main__":
    grammar = Grammar()
    grammar.build()
    gen = Generator(grammar,p_grow=0.65,max_depth=8)
