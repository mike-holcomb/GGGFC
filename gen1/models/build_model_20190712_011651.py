def build_model_20190712_011651(num_channels):
    ...
    y43 = LeakyReLU()(y42)
    y44 = Conv2D(2*num_channels, (1,1), padding='same', use_bias=False)(y10)
    ...
    y52 = LeakyReLU()(y51)
    y53 = Concatenate()([y22, y31, y43, y52])
