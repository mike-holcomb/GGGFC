def build_model_20190712_101021(num_channels):
    ...
    y60 = LeakyReLU()(y59)
    y61 = Conv2D(8*num_channels, (3,3), padding='same', use_bias=False)(y49)
    y62 = BatchNormalization()(y61)
    y63 = LeakyReLU()(y62)
    y64 = Concatenate()([y52, y55, y60, y63])
    ...
    y73 = LeakyReLU()(y72)
    y74 = Conv2D(64*num_channels, (1,1), padding='same', use_bias=False)(y68)
