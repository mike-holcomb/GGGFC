def build_model_20190713_022517(num_channels):
    ...
    y35 = LeakyReLU()(y34)
    y36 = Conv2D(2*num_channels, (3,3), padding='same', use_bias=False)(y29)
