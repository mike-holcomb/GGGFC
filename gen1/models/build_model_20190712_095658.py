def build_model_20190712_095658(num_channels):
    ...
    y28 = LeakyReLU()(y27)
    y29 = Add()([y28, y25])
    y30 = Conv2D(1*num_channels, (3,3), padding='same', use_bias=False)(y12)
    ...
    y39 = LeakyReLU()(y38)
    y40 = Add()([y39, y34])
    y41 = Conv2D(1*num_channels, (1,1), padding='same', use_bias=False)(y12)
    y42 = BatchNormalization()(y41)
    y43 = LeakyReLU()(y42)
    y44 = Conv2D(1*num_channels, (3,3), padding='same', use_bias=False)(y43)
    y45 = BatchNormalization()(y44)
    y46 = LeakyReLU()(y45)
    y47 = Conv2D(1*num_channels, (3,3), padding='same', use_bias=False)(y46)
    y48 = BatchNormalization()(y47)
    y49 = LeakyReLU()(y48)
    y50 = Add()([y46, y49])
    y51 = Concatenate()([y22, y29, y40, y50])
    ...
    y67 = LeakyReLU()(y66)
    y68 = Conv2D(8*num_channels, (3,3), padding='same', use_bias=False)(y58)
    ...
    y77 = LeakyReLU()(y76)
    y78 = Conv2D(8*num_channels, (3,3), padding='same', use_bias=False)(y58)
    y79 = BatchNormalization()(y78)
    y80 = LeakyReLU()(y79)
    y81 = Conv2D(8*num_channels, (3,3), padding='same', use_bias=False)(y58)
    y82 = BatchNormalization()(y81)
    y83 = Conv2D(8*num_channels, (3,3), padding='same', use_bias=False)(y82)
    y84 = BatchNormalization()(y83)
    y85 = LeakyReLU()(y84)
    y86 = Concatenate()([y67, y77, y80, y85])
