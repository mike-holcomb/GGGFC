def build_model_20190716_105603(num_channels):
    ...
    y19 = LeakyReLU()(y18)
    y20 = Conv2D(2*num_channels, (3,3), padding='same', use_bias=False)(y11)
    ...
    y54 = LeakyReLU()(y53)
    y55 = Conv2D(8*num_channels, (3,3), padding='same', use_bias=False)(y43)
