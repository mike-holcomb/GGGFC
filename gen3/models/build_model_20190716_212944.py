def build_model_20190716_212944(num_channels):
    ...
    y38 = LeakyReLU()(y37)
    y39 = Concatenate()([y28, y38])
    y40 = Conv2D(8*num_channels, (3,3), (2,2), padding='same', use_bias=False)(y39)
