def build_model_20190717_091909(num_channels):
    ...
    y31 = LeakyReLU()(y30)
    y32 = Add()([y31, y25])
    y33 = Conv2D(2*num_channels, (3,3), (2,2), padding='same', use_bias=False)(y32)
    ...
    y50 = LeakyReLU()(y49)
    y51 = Conv2D(2*num_channels, (1,1), padding='same', use_bias=False)(y50)
